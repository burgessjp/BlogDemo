...
#ifndef _Included_me_solidev_ffmpegpushstreamdemo_FFmpegPushStream
#define _Included_me_solidev_ffmpegpushstreamdemo_FFmpegPushStream
#ifdef __cplusplus
extern "C" {
#endif

/*
 * Class:     me_solidev_ffmpegpushstreamdemo_FFmpegPushStream
 * Method:    pushStream
...
JNIEXPORT jint JNICALL Java_me_solidev_ffmpegpushstreamdemo_FFmpegPushStream_pushStream
        (JNIEnv *env, jobject jclass, jstring input_jstr, jstring output_jstr) {
